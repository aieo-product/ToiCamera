...
| 🗣 | **AI explanations** spoken out loud — cloud TTS, **GPT Realtime** (one live session streams the voice while it plays), **on-device Japanese TTS ([sanoTTS-jp](https://github.com/ayutaz/sanoTTS-jp), 559K params, no audio API key)**, or Animal-Crossing-style chirps |
